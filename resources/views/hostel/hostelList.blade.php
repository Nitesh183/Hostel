    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center align-middle">
                ...
                <a title="Delete Hostel" href="{{route('deleteHostel', $hostel->hostel_id)}}" onclick="return confirm('Are you sure you want to delete the hostel?');"><i class="fas fa-trash-alt" style="color:red;"></i></a>
                <a title="Update Hostel" href="{{route('updateHostel', $hostel->hostel_id)}}"><i class="fas fa-edit" style="color:grey;"></i></a>
            </td>
        </tr>
        @endforeach
    </tbody>
